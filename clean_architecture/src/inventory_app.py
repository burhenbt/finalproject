...
import os
from datetime import datetime #needed for new inventory times
...
#WORK
	def new_inventory(self):
		...
		description = input("Enter poduct description: ")
		date = datetime.now()
		self.business_logic.create_new_inventory(name, description, date) #connects to business_logic
		print(f'---Row(s) inserted---')
...
#WORK
	def add_items(self):
		...
		count = input("Type number of products: ")
		inventory_id = input("Type unique product ID: ")
		self.business_logic.create_new_item(inventory_id, name, count) #connects to business_logic
		print(f'---Items(s) inserted---')
		input('\n\nPress any key to continue: ')
